...
const ProfileSection = () => {
    ...
    const handleClose = (event, path) => {
        ...
        setOpen(false);
        navigate(path); // Close the Popper and navigate to the specified path
    };
        ...
        <>
            <Chip
                ...
                icon={
                    ...
                    <Avatar
                        src={`https://testlobbiyst.s3.amazonaws.com/${profileImg}`}
                        sx={{
                ...
                label={<IconSettings stroke={1.5} size="1.5rem" color='purple' />}
                variant="outlined"
                ref={anchorRef}
                aria-controls={open ? 'menu-list-grow' : undefined}
                aria-haspopup="true"
                        ...
                        <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    ...
                                    {/* <PerfectScrollbar style={{ height: '100%', maxHeight: 'calc(100vh - 250px)' }}> */}
                                    <Box>
                                        <List
                                            component="nav"
                                            sx={{
                                        ...
                                        >
                                            <ListItemButton
                                                ...
                                                onClick={(event) => handleClose(event, '/admins/user-profile')}
                                            >
                                                <ListItemIcon>
                                            ...
                                            <ListItemButton
                                                sx={{ borderRadius: `${customization.borderRadius}px` }}
                                                selected={selectedIndex === 4}
                                                onClick={(event) => handleClose(event, '/resetpassword')}
                                            >
                                                <ListItemIcon>
